...
if __name__ == '__main__':
    ...
    from template import dogeusdc, ethusdc, fogousdt, litusdt, nightusdt, naorisusdt
    
    tasks = [
        ethusdc.long_buy_position_reverse(main_binance_client),
        ...
        naorisusdt.long_buy_position_reverse(main_binance_client),
    ]
